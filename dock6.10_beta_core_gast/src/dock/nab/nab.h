...
typedef	struct	curhash_t	{
	...
	/* used to remember the previous select value of*/
...
#define	T_BOUNDS	11
#define	T_NULL		12
#define	T_ERROR		13	/* stops printing of spur. e-msgs	*/
#define	T_HASH		14	/* never input */
#define	T_CURHASH	15	/* never input */
#define	T_LDABOUND	16	/* local dyn array bnd. never input	*/
#define	T_GDABOUND	17	/* global dyn array bnd. never input	*/
#define	N_TYPES		18
