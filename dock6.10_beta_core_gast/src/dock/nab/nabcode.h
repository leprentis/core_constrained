...
REAL_T      gauss( REAL_T*, REAL_T*, INT_T* );
...
#define	HRI(h,k,t)	NAB_href((h),(k),(t))->v_value.v_ival
#define	HRSZ(h,k,t)	NAB_href((h),(k),(t))->v_value.v_szval
#define	HRF(h,k,t)	NAB_href((h),(k),(t))->v_value.v_fval
#define	HRC(h,k,t)	NAB_href((h),(k),(t))->v_value.v_cval
#define	HRPT(h,k,t)	NAB_href((h),(k),(t))->v_value.v_ptval
#define	HRMAT(h,k,t)	NAB_href((h),(k),(t))->v_value.v_matval
#define	HRFP(h,k,t)	NAB_href((h),(k),(t))->v_value.v_fpval
#define	HRATOM(h,k,t)	NAB_href((h),(k),(t))->v_value.v_atomval
#define	HRRES(h,k,t)	NAB_href((h),(k),(t))->v_value.v_resval
#define	HRMOL(h,k,t)	NAB_href((h),(k),(t))->v_value.v_molval
#define	HRB(h,k,t)	NAB_href((h),(k),(t))->v_value.v_bval
