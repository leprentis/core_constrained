...
/*
 * typedef char HASH_T; typedef struct curhash_t { int index; char *pointer; }
 * CURHASH_T; 
 */
...
INT_T           andbounds(BOUNDS_T *, MOLECULE_T *, STRING_T *, STRING_T *,
                          REAL_T, REAL_T);
...
INT_T           conjgrad(REAL_T *, INT_T *, REAL_T *,
                         REAL_T(*func) (REAL_T *, REAL_T *, INT_T *), REAL_T *,
                         REAL_T *, INT_T *);
INT_T           conmin();
INT_T           connectres(MOLECULE_T *, STRING_T *, INT_T, STRING_T *, INT_T,
                           STRING_T *);
...
INT_T           descent();
MOLECULE_T     *dg_helix(STRING_T **, STRING_T **, STRING_T **, STRING_T **,
                         STRING_T **, STRING_T **, REAL_T *, REAL_T *, REAL_T *,
                         REAL_T *, STRING_T **);
...
MOLECULE_T     *dna3_to_allatom(MOLECULE_T **, STRING_T **, STRING_T **,
                                STRING_T **, STRING_T **);
BOUNDS_T       *dt_to_bmat(MOLECULE_T **, STRING_T **, STRING_T **);
INT_T           dt_to_prmtop(STRING_T **, STRING_T **, STRING_T **, STRING_T **,
                             STRING_T **);
...
REAL_T          getchivol(MOLECULE_T **, STRING_T **, STRING_T **, STRING_T **,
                          STRING_T **);
REAL_T          getchivolp(POINT_T, POINT_T, POINT_T, POINT_T);
MOLECULE_T     *getcif(STRING_T *, STRING_T *);
INT_T           getxyz_from_pdb(STRING_T **, MOLECULE_T **, STRING_T **,
                                INT_T *);
INT_T           getseq_from_pdb(STRING_T **, INT_T *, STRING_T **, STRING_T **,
                                STRING_T **);
MOLECULE_T     *getpdb(STRING_T *, STRING_T *);
MOLECULE_T     *getpdb_prm(STRING_T **, STRING_T **, STRING_T **, INT_T *);
MOLECULE_T     *getpdb_rlb(STRING_T **, STRING_T **, STRING_T **, STRING_T **,
                           STRING_T **);
...
INT_T           leap(MOLECULE_T **, STRING_T **, STRING_T **);
INT_T           length(STRING_T ***);
MOLECULE_T     *linkprot(STRING_T **, STRING_T **, STRING_T **);
MOLECULE_T     *link_na(STRING_T **, STRING_T **, STRING_T **, STRING_T **,
                        STRING_T **);
INT_T           md(INT_T, INT_T, REAL_T *, REAL_T *, REAL_T *,
                   REAL_T(*mme) (REAL_T *, REAL_T *, INT_T *));
INT_T           mdrat(INT_T, INT_T, REAL_T *, REAL_T *, REAL_T *, REAL_T *,
                      REAL_T(*mme) ());
INT_T           mergestr(MOLECULE_T *, STRING_T *, STRING_T *, MOLECULE_T *,
                         STRING_T *, STRING_T *);
...
INT_T           mme_init(MOLECULE_T *, STRING_T *, STRING_T *, REAL_T *,
                         FILE_T *);
INT_T           mme_timer();
...
INT_T           orbounds(BOUNDS_T *, MOLECULE_T *, STRING_T *, STRING_T *,
                         REAL_T, REAL_T);
...
INT_T           putxv(STRING_T **, STRING_T **, INT_T *, REAL_T *, REAL_T *,
                      REAL_T *);
REAL_T          rand2(INT_T *);
INT_T           readbinposhdr(FILE *);
INT_T           readbinposfrm(INT_T, REAL_T *, FILE *);
INT_T           readparm(MOLECULE_T *, STRING_T *);
INT_T           rmsd(MOLECULE_T **, STRING_T **, MOLECULE_T **, STRING_T **,
                     REAL_T *);
MATRIX_T       *rot4(MOLECULE_T *, STRING_T *, STRING_T *, REAL_T);
MATRIX_T       *rot4p(POINT_T, POINT_T, REAL_T);
FILE_T         *safe_fopen(STRING_T *, STRING_T *);
INT_T           sasad(REAL_T *, REAL_T *, REAL_T *, INT_T, REAL_T);
REAL_T          second();
INT_T           setbounds(BOUNDS_T *, MOLECULE_T *, STRING_T *, STRING_T *,
                          REAL_T, REAL_T);
INT_T           setboundsfromdb(BOUNDS_T **, MOLECULE_T **, STRING_T **,
                                STRING_T **, STRING_T **, REAL_T *);
INT_T           setchiplane(BOUNDS_T **, MOLECULE_T **, STRING_T **);
INT_T           setchivol(BOUNDS_T *, MOLECULE_T *, STRING_T *, STRING_T *,
                          STRING_T *, STRING_T *, REAL_T);
INT_T           setframe(INT_T, MOLECULE_T *, STRING_T *, STRING_T *,
                         STRING_T *, STRING_T *, STRING_T *);
INT_T           setframep(INT_T, MOLECULE_T *, POINT_T, POINT_T, POINT_T,
                          POINT_T, POINT_T);
...
STRING_T       *timeofday();
INT_T           tleap(STRING_T *);
MATRIX_T       *trans4(MOLECULE_T *, STRING_T *, STRING_T *, REAL_T);
MATRIX_T       *trans4p(POINT_T, POINT_T, REAL_T);
REAL_T          torsion(MOLECULE_T *, STRING_T *, STRING_T *, STRING_T *,
                        STRING_T *);
...
INT_T           useboundsfrom(BOUNDS_T *, MOLECULE_T *, STRING_T *,
                              MOLECULE_T *, STRING_T *, REAL_T);
...
/*
 * typedef struct { int v_type; union { int v_ival; REAL_T v_fval; char
 * *v_cval; REAL_T v_ptval[ 3 ]; char *v_matval; FILE *v_fpval; char
 * *v_atomval; char *v_molval; char *v_resval; char *v_bval; } v_value; }
 * VALUE_T; 
 */
...
#define	HRI(h,k)	NAB_href((h),(k))->v_value.v_ival
#define	HRF(h,k)	NAB_href((h),(k))->v_value.v_fval
#define	HRC(h,k)	NAB_href((h),(k))->v_value.v_cval
#define	HRPT(h,k)	NAB_href((h),(k))->v_value.v_ptval
#define	HRMAT(h,k)	NAB_href((h),(k))->v_value.v_matval
#define	HRFP(h,k)	NAB_href((h),(k))->v_value.v_fpval
#define	HRATOM(h,k)	NAB_href((h),(k))->v_value.v_atomval
#define	HRRES(h,k)	NAB_href((h),(k))->v_value.v_resval
#define	HRMOL(h,k)	NAB_href((h),(k))->v_value.v_molval
#define	HRB(h,k)	NAB_href((h),(k))->v_value.v_bval
