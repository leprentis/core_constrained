...
c-----------------------------------------------------------------------
      real function dist4(c1,c2)
c
c  ---calculates the distance dependence of the Coulomb approximation to the
c     electric displacement
c

      real c1(3), c2(3)
      dist4 = (c1(2)-c2(2)/(abs(c1(2)-c2(2)))**3)  
c     &        (c1(2)-c2(2)/(abs(c1(2)-c2(2)))**3)  +
c     &        (c1(3)-c2(3)/(abs(c1(3)-c2(3)))**3)
      return
      end 
