...
def mkgrid(prefix,list,gridinputfilename):
    ...
    for v in list:
        ...
        # /projects2/insite/lauren.prentis/dock6_builds/dock6.10_beta_core_gast will be replaced during installation; 
        # single quotes to support spaces in pathnames on some OS's.
        gridpath = "'/projects2/insite/lauren.prentis/dock6_builds/dock6.10_beta_core_gast'/bin/grid"
